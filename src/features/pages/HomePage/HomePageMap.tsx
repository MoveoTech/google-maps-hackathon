            ...
            <TapGestureHandler>
                ...
                >
                    <View style={{
                        ...
                        <Button style={{marginTop: 20, borderRadius: 10, backgroundColor: 'white'}}
                                labelStyle={{color: 'black'}} mode={"outlined"}
                                onPress={replaceTopFour} icon={require('../../../../assets/Vector.png')}>
